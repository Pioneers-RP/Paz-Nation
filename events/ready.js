    ...
    execute(client) {
                ...
                function chaquePays(value, index, array) {
                    ...
                    connection.query(sql, async(err, results) => {
                        ...
                        if (conso_briqueterie == true) {
                            ...
                            if (manque_bois == true) {
                                manque.push({
                                    name: `> ⛔ Manque de bois ⛔ :`,
                                    value: `Bois : ${results[0].bois}/${conso_T_briqueterie_bois}\n`
                                })
                            }
                            if (manque_eau == true) {
                                manque.push({
                                    name: `> ⛔ Manque d\'eau ⛔ :`,
                                    value: `Eau : ${results[0].eau}/${conso_T_briqueterie_eau}\n`
                                })
                            }
                    ...
                    connection.query(sql, async(err, results) => {
                        ...
                        if (conso_champ == true) {
                            ...
                            var prod_T_champ = process.env.PROD_CHAMP * results[0].champ;
                            var sql = `
                            ...
                            if (manque_eau == true) {
                                manque.push({
                                    name: `> ⛔ Manque d\'eau ⛔ :`,
                                    value: `Eau : ${results[0].eau}/${conso_T_champ_eau}\n`
                                })
                            }
                    ...
                    connection.query(sql, async(err, results) => {
                        ...
                        if (conso_mine == true) {
                            ...
                            var prod_T_mine = process.env.PROD_MINE * results[0].mine;
                            var sql1 = `
                            ...
                            if (manque_bois == true) {
                                manque.push({
                                    name: `> ⛔ Manque de bois ⛔ :`,
                                    value: `Bois : ${results[0].bois}/${conso_T_mine_bois}\n`
                                })
                            }
                            if (manque_petrole == true) {
                                manque.push({
                                    name: `> ⛔ Manque de pétrole ⛔ :`,
                                    value: `Pétrole : ${results[0].petrole}/${conso_T_mine_petrole}\n`
                                })
                            }
                    ...
                    connection.query(sql, async(err, results) => {
                        ...
                        if (conso_pompe_a_eau == true) {
                            ...
                            var prod_T_pompe_a_eau = process.env.PROD_POMPE_A_EAU * results[0].pompe_a_eau;
                            var sql = `
                            ...
                            if (manque_petrole == true) {
                                manque.push({
                                    name: `> ⛔ Manque de pétrole ⛔ :`,
                                    value: `Pétrole : ${results[0].petrole}/${conso_T_pompe_a_eau_petrole}\n`
                                })
                            }
                    ...
                    connection.query(sql, async(err, results) => {
                        ...
                        if (conso_pumpjack == true) {
                            ...
                            var prod_T_pumpjack = process.env.PROD_PUMPJACK * results[0].pumpjack;
                            var sql = `
                    ...
                    connection.query(sql, async(err, results) => {
                        ...
                        if (conso_scierie == true) {
                            ...
                            var prod_T_scierie = process.env.PROD_SCIERIE * results[0].scierie;
                            var sql = `
                            ...
                            if (manque_petrole == true) {
                                manque.push({
                                    name: `> ⛔ Manque de pétrole ⛔ :`,
                                    value: `Pétrole : ${results[0].petrole}/${conso_T_scierie_petrole}\n`
                                })
                            }
                    ...
                    connection.query(sql, async(err, results) => {
                        ...
                        if (conso_usine_civile == true) {
                            ...
                            if (manque_bois == true) {
                                manque.push({
                                    name: `> ⛔ Manque de bois ⛔ :`,
                                    value: `Bois : ${results[0].bois}/${conso_T_usine_civile_bois}\n`
                                })
                            }
                            if (manque_metaux == true) {
                                manque.push({
                                    name: `> ⛔ Manque de métaux ⛔ :`,
                                    value: `Métaux : ${results[0].metaux}/${conso_T_usine_civile_metaux}\n`
                                })
                            }
                            if (manque_petrole == true) {
                                manque.push({
                                    name: `> ⛔ Manque de pétrole ⛔ :`,
                                    value: `Pétrole : ${results[0].petrole}/${conso_T_usine_civile_petrole}\n`
                                })
                            }
                        ...
                        if (habitants < nourriture) {
                            ...
                            const embed = {
                                ...
                                fields: {
                                    ...
                                    value: `Nourriture : ${results[0].nourriture}/${habitants}\n` +
                                        `Morts : ${mort}\n` +
                                        `Population restante : ${habitants_next}\n`
                                },
                                color: 'RED',
                                timestamp: new Date(),
                                footer: { text: `${results[0].devise}` }
                            ...
                            var sql = `
                                UPDATE pays SET nourriture=nourriture-${habitants_next} WHERE id_joueur='${results[0].id_joueur}';
        ...
        async function marketUpdate() {
            ...
            connection.query(sql, async(err, results) => {
                ...
                box.set('bc_prix_moyen', bc_prix_moyen.toFixed(2));

                bois_prix_moyen = bois_prix_total / bois_res_total;
                box.set('bois_prix_moyen', bois_prix_moyen.toFixed(2));

                brique_prix_moyen = brique_prix_total / brique_res_total;
                box.set('brique_prix_moyen', brique_prix_moyen.toFixed(2));

                eau_prix_moyen = eau_prix_total / eau_res_total;
                box.set('eau_prix_moyen', eau_prix_moyen.toFixed(2));

                metaux_prix_moyen = metaux_prix_total / metaux_res_total;
                box.set('metaux_prix_moyen', metaux_prix_moyen.toFixed(2));

                nourriture_prix_moyen = nourriture_prix_total / nourriture_res_total;
                box.set('nourriture_prix_moyen', nourriture_prix_moyen.toFixed(2));

                petrole_prix_moyen = petrole_prix_total / petrole_res_total;
                box.set('petrole_prix_moyen', petrole_prix_moyen.toFixed(2));
