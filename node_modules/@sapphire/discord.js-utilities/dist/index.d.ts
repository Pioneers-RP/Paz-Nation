...
import { MessageOptions, CategoryChannel, DMChannel, PartialDMChannel, NewsChannel, StageChannel, StoreChannel, TextChannel, ThreadChannel, VoiceChannel, GuildChannel, Channel, Message, CommandInteraction, ContextMenuInteraction, SelectMenuInteraction, ButtonInteraction, ModalSubmitInteraction, PartialTextBasedChannelFields, EmojiIdentifierResolvable, User, CollectorFilter, MessageReaction, CollectorOptions, GuildEmoji, ReactionEmoji, EmojiResolvable, InteractionButtonOptions, ExcludeEnum, LinkButtonOptions, MessageSelectMenuOptions, InteractionCollector, MessageComponentInteraction, MessageEmbed, MessageSelectOptionData, WebhookEditMessageOptions, Guild, Interaction, InteractionReplyOptions, InteractionUpdateOptions, ReplyMessageOptions, MessageEditOptions, TextBasedChannel, Collection, Snowflake, MessageEmbedOptions, EmbedFieldData, MessageButton, MessageSelectMenu, MessageActionRow, PartialGroupDMChannel, BaseGuildVoiceChannel, BaseCommandInteraction, GuildMember, VoiceBasedChannel } from 'discord.js';
...
import { APIMessage, APIGuildMember, APIInteractionGuildMember, APIInteractionDataResolvedGuildMember } from 'discord-api-types/v9';
 ...
 */
declare type ChatInputOrContextMenuInteraction = CommandInteraction | ContextMenuInteraction;
/**
 ...
 */
declare type NonModalInteraction = ChatInputOrContextMenuInteraction | SelectMenuInteraction | ButtonInteraction;
/**
 * A union of {@link CommandInteraction}, {@link ContextMenuInteraction}, {@link SelectMenuInteraction}, {@link ButtonInteraction}, and {@link ModalSubmitInteraction};
 */
declare type AnyInteraction = NonModalInteraction | ModalSubmitInteraction;
...
declare class PaginatedMessage {
     ...
     */
    response: APIMessage | Message | NonModalInteraction | null;
    /**
     ...
     */
    run(messageOrInteraction: Message | NonModalInteraction, target?: User): Promise<this>;
    /**
     ...
     */
    protected setUpMessage(messageOrInteraction: Message | NonModalInteraction, targetUser: User): Promise<void>;
    /**
     ...
     */
    protected resolvePaginatedMessageInternationalizationContext(messageOrInteraction: Message | NonModalInteraction, targetUser: User): PaginatedMessageInternationalizationContext;
 ...
 */
declare const runsOnInteraction: (messageOrInteraction: discord_api_types_v9.APIMessage | discord_js.Message<boolean> | discord_js.BaseCommandInteraction<discord_js.CacheType> | AnyInteraction) => () => boolean;
 ...
 * @returns `true` if the `messageOrInteraction` is **NOT** an instanceof {@link Message}, `false` if it is.
 */
declare function isAnyInteraction(messageOrInteraction: APIMessage | Message | BaseCommandInteraction | AnyInteraction): messageOrInteraction is AnyInteraction;
/**
