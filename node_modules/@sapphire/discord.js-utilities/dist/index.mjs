  ...
  setUpCollector(channel, targetUser) {
    if (this.pages.length > 1) {
      this.collector = new InteractionCollector(targetUser.client, {
        filter: (interaction) => !isNullish4(this.response) && interaction.message.id === this.response?.id && interaction.isMessageComponent() && this.actions.has(interaction.customId),
        time: this.idle,
